![docker image](https://github.com/HussainArif12/NOMAD-Oasis/actions/workflows/docker-publish.yml/badge.svg)


# HussainArif12's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of HussainArif12.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/HussainArif12/NOMAD-Oasis.git
    cd NOMAD-Oasis
    ```
    ...
    ```sh
    curl-L -o NOMAD-Oasis.zip "https://github.com/HussainArif12/NOMAD-Oasis/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/hussainarif12/nomad-oasis:main` for the services
...
```sh
docker pull ghcr.io/hussainarif12/nomad-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/HussainArif12/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/HussainArif12/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/HussainArif12/NOMAD-Oasis/manifests/main": unauthorized`
